...
import tf
from traxster_nav.transform_utils import quat_to_angle, normalize_angle
...
class NavSquare():
    def __init__(self):
        ...
        linear_speed = rospy.get_param("~linear_speed", 0.05)        # meters per second
        angular_speed = rospy.get_param("~angular_speed", 0.15)      # radians per second
